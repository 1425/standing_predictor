...
std::vector<std::tuple<std::string,std::string,std::string>> const& zipcode_data(){
	static const std::vector<std::tuple<std::string,std::string,std::string>> r{
		...
		{"94123","San Francisco","San Francisco"},
		...
		{"94156","San Francisco","San Francisco"},
		...
		{"95172","San Jose","Santa Clara"},
		{"95173","San Jose","Santa Clara"},
		{"95190","San Jose","Santa Clara"},
